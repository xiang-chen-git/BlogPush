...
/*
    ...
    I won't go in to much detail about this class, so all you need to know
    is that this is what creates the zoom animation used with all posts and pages.
 
*/

#import "BITViewZoomAnimation.h"

@interface BITViewZoomAnimation ()

@property (nonatomic, strong) id<UIViewControllerContextTransitioning> transitionContext;

@end

@implementation BITViewZoomAnimation
